...
// 2. 单一来源版本号（不另写死）。仓库里的 package.json 恒为 0.0.0，本脚本不改它，
...
const semver=ver.replace(/^beta/,''); // electron-builder 要 x.y.z；beta0.7.3 -> 0.7.3
...
execFileSync(process.execPath,[ebCli,'--win','--config','electron-builder.yml',
