...
2026-09-26 已发布：[PR #13](https://github.com/SzuDesktopTeam/szudesktop/pull/13) 已合并，[版本检查](https://github.com/SzuDesktopTeam/szudesktop/actions/runs/36220458700) 全部通过，含安装、主窗与宠物、重启尺寸恢复、同版本重装保留存档和卸载。真实学校账号验收仍待学校连接恢复。
