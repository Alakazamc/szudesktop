...
1.0 优先收口学校登录与会话接回、所承诺的课表/成绩查询、可靠的官方预约入口，以及跨版本升级与存档保留。校内公共后端尚未部署，首期只规划服务目录、公共公告、校历和版本信息。自动更新尚未实现：内容数据可后续独立刷新，程序逻辑仍计划整包更新并重启；当前安装包未签名，跨版本升级尚未实测。计划和验收只维护在 [STATUS 第 50 节](docs/STATUS.md#50-四位伙伴与-10-收口计划2026-09-26开发中未发布)。
